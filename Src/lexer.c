		...
		case '9':   /*  0b  - binary        */
			...
			*p = '\0';
			...
			if (binary) {
				...
				if((lineno==linetest)&&(pass==0)) printf("%d: Binary %lXH\n", lineno, value);
				yylval.value = value;
				return(VALUE);
			}
			...
			if (hex) {
				...
				if((lineno==linetest)&&(pass==0)) printf("%d: Hex %lXH\n", lineno, value);
				yylval.value = value;
				return(VALUE);
			}
			...
			if (octal) {
				...
				if((lineno==linetest)&&(pass==0)) printf("%d: Octal %loQ\n", lineno, value);
				yylval.value = value;
				return(VALUE);
			}
			...
			if (decimal) {
				...
				if((lineno==linetest)&&(pass==0)) printf("%d: Decimal %ld\n", lineno, value);
				yylval.value = value;
				return(VALUE);
			}
